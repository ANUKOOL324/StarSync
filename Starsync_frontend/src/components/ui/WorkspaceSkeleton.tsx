...
export function WorkspaceSkeleton() {
  return (
    <div className="flex h-dvh w-screen flex-col bg-[#05070A] text-zinc-400 select-none overflow-hidden">
      ...
      <div className="flex flex-1 min-h-0 p-3 gap-3 overflow-hidden">
        ...
        <div className="hidden lg:flex flex-col w-[28%] shrink-0 rounded-xl border border-white/5 bg-[#080B10]/80 p-4 gap-4 overflow-hidden">
        ...
        <div className="flex flex-col flex-1 rounded-xl border border-white/5 bg-[#080B10]/80 overflow-hidden">
          ...
          <div className="flex-1 p-4 space-y-3 font-mono text-sm">
            <div className="flex items-center gap-4">
        ...
        <div className="flex flex-col w-full sm:w-80 lg:w-[24%] shrink-0 rounded-xl border border-white/5 bg-[#080B10]/80 p-4 gap-4 overflow-hidden">
          ...
          <div className="h-10 w-full animate-pulse rounded-xl border border-white/5 bg-white/[0.02]" />
        </div>
